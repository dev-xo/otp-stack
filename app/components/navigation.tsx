  ...
  return (
    <header
      ...
      <Link
        ...
        <span className="font-bold text-gray-200">Remix Auth </span>&nbsp;OTP
        <div className="mx-1" />
        <small className="relative top-[2px] text-sm font-bold text-violet-200">
          v2.0
        </small>
      </Link>
      ...
      <div className="flex flex-row items-center">
        <a
          href="https://github.com/dev-xo/remix-auth-otp"
          target="_blank"
